---
title: "CodeBook for tidydat.txt"
output: 
  html_document:
    keep_md: true
---
...
```{r ReadCodebook, echo=FALSE}

library(pander)
Codebook <- read.table(file="./codebook.txt", header=FALSE)
names(Codebook) <- c("ColumnNumber","Description")
pandoc.table(Codebook)
```
